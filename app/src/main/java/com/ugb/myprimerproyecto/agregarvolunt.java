...
public class agregarvolunt extends AppCompatActivity {
    ...
    private void agregar() {
        try {
            ...
            temp = findViewById(R.id.txtdonacion);
            String donacion = temp.getText().toString();

            temp = findViewById(R.id.txtdirreccion);
            String dirreccion = temp.getText().toString();
            ...
            datoss.put("dirreccion",dirreccion);
    ...
    private void mostrardatos() {
        try {
            ...
            if(accion.equals("modificar")){
                ...
                temp = findViewById(R.id.txtdirreccion);
                temp.setText(datos.getString("dirreccion"));
